                                                ...
                                                children: [
                                                  ...
                                                  Column(
                                                    ...
                                                    children: [
                                                      const Text('Harga :'),
                                                      Text(
                                                        'Rp. ${dataSvcDtlJasa?[index].hargaSparepart}',
                                                        style: const TextStyle(fontWeight: FontWeight.bold),
                                                      ),
                                                    ],
                                                  ),
                            ...
                            FutureBuilder<DetailSpertpart>(
                              ...
                              builder: (context, snapshot) {
                                if (snapshot.connectionState == ConnectionState.waiting) {
                                  ...
                                  return Column(
                                    children: [
                                      for (int index = 0; index < (photoSparepart?.length ?? 0); index++)
                                        Text(
                                          'Kode Sparepart: ${photoSparepart?[index].kodeSparepart}',
                                          style: const TextStyle(fontWeight: FontWeight.bold),
                                        ),
                                    ],
                                  );
...
// so whatever you want to refresh it must be inside the setState
      const CardDetailPKBSperepart(); // if you only want to refresh the list you can place this, so the two can be inside setState
      _refreshController
