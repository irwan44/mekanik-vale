          ...
          Expanded(
            child: InkWell(
              ...
              child: Container(
                ...
                child: Text(
                  "PKB Service",
                  style: (activePageIndex == 0) ? TextStyle(color: Colors.white) : TextStyle(color: MyColors.appPrimaryColor),
                ),
              ),
            ),
          ),
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: Text(
                  ...
                  style: (activePageIndex == 1) ? TextStyle(color: Colors.white, fontWeight: FontWeight.bold) : TextStyle(color: MyColors.appPrimaryColor, fontWeight: FontWeight.bold),
                ),
              ),
            ),
          ),
